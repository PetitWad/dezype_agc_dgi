            ...
            <?php if(isset($exc)) : ?>
                <div class="container alert alert-success">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <h6>NOM COMPLET : <?php echo strtoupper($rstRow['super_user_nom']) .' '. ucfirst($rstRow['super_user_prenom']);  ?> </h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 compte">
                            <div class="row">
                                <!-- <div class="col-3"></div> -->
                                <div class="col-6">
                                    <p class="titre"><a href="compteSuperUser.php">Créer un compte DGI</a></p>
                                </div>
                                <div class="col-6">
                                    <p class="titre one"><a href="compteSimpleUser.php">Créer un compte simple</a></p>
                                </div>
                                <!-- <div class="col-3"></div> -->
                        </div>
                            <form action="./compteSuperUser.php" method="POST">
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-2">
