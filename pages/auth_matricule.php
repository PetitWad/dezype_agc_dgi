...
// Requette dans la table revenu imposable pour authentifier
    ...
    endforeach;  
     ...
     if($nif == $nifVerifier){
        header("Location: impri_matricule.php?nif=$nif");
     }else{
        header("Location: auth_matricule.php?errAuth=😥Donnees sont introuvables...");
     }
                ...
                <div class="row">
                    ...
                    <div id=formContent class="col-6">
                        <form action="#" method="post">
                            <h5> <span>IMPRIMER MATRICULE EXISTANT<br></span> NIF pour authentifier</h5><br>
