...
<body onload="window.print()">
    ...
    <!-- <div class="col-3"></div> -->
        <!-- <div class="row ">
            <div class="col-3 "><a href="#" class="btn btn-primary">IMPRIMER &nbsp; <i class="bi bi-printer"></i></a></button> </div>
            <div class="col-2"><a href="impot.php" class="btn btn-danger">Retour</a></button> </div>
            <div class="col-7"></div>
        </div> -->
    </div> 
</div>
